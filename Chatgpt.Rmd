...
Ein weiteres Anwendungsfeld ist die Generierung von Code für das Behfehlsset [Ti*k*Z](https://tikz.dev/) innerhalb von $\TeX$. Der Dienst wirkt hier zögerlicher als bei der Ausgabe von R-Code, aber er liefert brauchbare Antworten.
